...
Route::group(['middleware' => ['auth']], function () {
  ...
  Route::patch('setActive/{id}', 'App\Http\Controllers\ProductsController@setActive')->name('setMenuActive');

  Route::patch('setNonActive/{id}', 'App\Http\Controllers\ProductsController@setNonActive')->name('setMenuNonActive');

  Route::get('generate_pdf', 'App\Http\Controllers\OrderController@generatePdf')->name('pdf');
});
